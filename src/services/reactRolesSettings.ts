...
export function matchEmoji(
    ...
    if (reactionEmoji.name && (s === reactionEmoji.name || s.includes(`:${reactionEmoji.name}:`))) return true;
    if (reactionEmoji.identifier && s === reactionEmoji.identifier) return true;
    return false;
}
