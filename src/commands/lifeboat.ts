...
import { viralExpansionStore, BotLifeboatBackup } from '../services/viralExpansionStore.js';
import { config } from '../config.js';

export const backupWorldCommand: Command = {
    data: new SlashCommandBuilder()
        ...
        .addStringOption((opt) =>
            opt
                ...
                .setRequired(false)
                .addChoices(
                    { name: 'Aternos', value: 'aternos' },
                    { name: 'BisectHosting', value: 'bisect' },
                    { name: 'Minehut', value: 'minehut' },
                    { name: 'Shockbyte', value: 'shockbyte' },
                    { name: 'Apex Hosting', value: 'apex' },
                    { name: 'Self-Hosted / VPS / Other', value: 'custom' }
                )
        )
    ...
    async execute(interaction) {
        ...
        const lifeboat: BotLifeboatBackup = {
