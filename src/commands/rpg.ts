...
export const mineCommand: Command = {
    ...
    async execute(interaction) {
        // Forward to rpg mine
        (interaction.options as any).data = [{ name: 'mine', type: 1 }];
        (interaction.options as any).getSubcommand = () => 'mine';
...
export const fishCommand: Command = {
    ...
    cooldown: 2,
    async execute(interaction) {
        (interaction.options as any).data = [{ name: 'fish', type: 1 }];
        (interaction.options as any).getSubcommand = () => 'fish';
        return rpgCommand.execute(interaction);
    },
};
...
export const sellCommand: Command = {
    ...
    cooldown: 2,
    async execute(interaction) {
        (interaction.options as any).getSubcommand = () => 'sell';
        (interaction.options as any).getString = (name: string) => name === 'category' ? 'all' : null;
        return rpgCommand.execute(interaction);
    },
};
...
export const craftCommand: Command = {
    ...
    cooldown: 2,
    async execute(interaction) {
        (interaction.options as any).getSubcommand = () => 'craft';
        return rpgCommand.execute(interaction);
    },
};
