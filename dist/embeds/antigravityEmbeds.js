 ...
 */
function formatTelemetry(result) {
    const parts = [];
 ...
 */
export function createProcessingEmbed(taskPreview, userTag, hasAttachments = false) {
 ...
 */
export function createResultEmbeds(result, options) {
    const embeds = [];
...
export function createUnauthorizedEmbed() {
    return new EmbedBuilder()
        ...
        .setDescription('The `/staffai` pipeline allows executing code, modifying files, and running server commands.\n\n' +
