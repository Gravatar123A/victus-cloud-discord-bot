...
export class InviteEmbeds {
     ...
     */
    static buildUserInvitesCard(stats, guild, targetUser, requesterId) {
        ...
        const body = `# 📨 INVITATION INTELLIGENCE\n` +
     ...
     */
    static buildLeaderboardCard(data, guild, requesterId, userStats) {
        ...
        if (data.entries.length > 0) {
            listText = data.entries
                ...
                return (`${medal} <@${e.userId}> — **${e.total}** invites\n` +
        ...
        const body = `# 🏆 INVITATION HALL OF FAME\n` +
        ...
        const row = new ActionRowBuilder().addComponents(new ButtonBuilder()
            ...
            .setDisabled(data.page <= 1), new ButtonBuilder()
            ...
            .setEmoji('▶️')
            .setStyle(ButtonStyle.Secondary)
            .setDisabled(data.page >= data.totalPages), new ButtonBuilder()
