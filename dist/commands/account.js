...
export const accountCommand = {
    ...
    async execute(interaction) {
        ...
        try {
            ...
            const container = ComponentsV2.userInfoContainer(interaction.user.tag, interaction.user.id, true, profile, servers, history, creditBalance, [], balances.found ? balances.coins : undefined);
