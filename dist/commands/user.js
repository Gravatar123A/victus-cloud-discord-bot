    ...
    async execute(interaction) {
        ...
        try {
            if (subcommand === 'info') {
                ...
                const container = ComponentsV2.userInfoContainer(targetUser.tag, targetUser.id, !!linkedAccount, profile, servers, history, creditBalance, services);
            ...
            const container = ComponentsV2.errorContainer('Data Fetch Error', 'An error occurred while retrieving user information.');
            await interaction.editReply({
                components: [container],
                flags: ComponentsV2.IS_COMPONENTS_V2
            });
