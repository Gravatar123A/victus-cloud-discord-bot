    ...
    async execute(interaction) {
        ...
        if (subGroup === 'channel') {
            if (subCommand === 'set') {
                ...
                const embed = new EmbedBuilder()
                    ...
                    .setDescription(`Counting has been bound to <#${targetChannel.id}> and is now **Active**!\n\n` +
        ...
        if (subCommand === 'enable') {
            ...
            const embed = new EmbedBuilder()
                ...
                .setDescription(`The counting system is now **Enabled**!\n\n` +
        ...
        if (subCommand === 'config') {
            ...
            const updates = {};
            if (resetMsg !== null)
                updates.resetMessage = resetMsg.trim();
            if (correctEmoji !== null)
                updates.correctEmoji = correctEmoji.trim();
            if (wrongEmoji !== null)
                updates.wrongEmoji = wrongEmoji.trim();
            ...
            const embed = new EmbedBuilder()
                ...
                .setDescription(Object.keys(updates).length > 0
                ...
                value: '• `{user}`: Mentions the perpetrator (`@user`)\n' +
        ...
        if (subCommand === 'status') {
            ...
            const embed = new EmbedBuilder()
                ...
                .addFields({ name: '📡 Status', value: statusText, inline: true }, { name: '💬 Channel', value: channelText, inline: true }, { name: '🎯 Next Number', value: `**${config.currentNumber + 1}**`, inline: true }, { name: '📊 Current Count', value: `\`${config.currentNumber}\``, inline: true }, { name: '🏆 High Score', value: `\`${config.highestScore}\``, inline: true }, {
                name: '👤 Last Counter',
