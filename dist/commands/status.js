...
export const statusCommand = {
    ...
    async execute(interaction) {
        ...
        if (matches.length > 1) {
            ...
            const container = ComponentsV2.baseContainer(ComponentsV2.Accents.info)
                .addTextDisplayComponents(ComponentsV2.text(`# Multiple Servers Found\n\n` +
        ...
        // 0 matches
        const container = ComponentsV2.warningContainer('Server Not Found', `No public server could be found matching **"${query}"**.\n\n` +
    ...
    async handleSelectMenu(interaction) {
        if (interaction.customId !== 'status_disambiguate')
            return;
