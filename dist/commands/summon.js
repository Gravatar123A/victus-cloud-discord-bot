...
import { summonChannel, dismissChannel, SUMMON_DEFAULT_MINUTES, SUMMON_MIN_MINUTES, SUMMON_MAX_MINUTES, } from '../services/summonedChannels.js';
...
export const summonCommand = {
    ...
    async execute(interaction) {
        ...
        await interaction.reply({
            content: `🔮 **Victus AI summoned.** I'll answer questions from everyone in this channel until <t:${unix}:t> (<t:${unix}:R>).\n` +
