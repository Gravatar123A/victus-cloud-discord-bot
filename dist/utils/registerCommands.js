...
import { getGlobalCommandData, getGuildCommandData } from '../commands/index.js';
 ...
 */
export async function registerApplicationCommands(source = 'startup') {
    ...
    if (instantGuilds.length > 0) {
        ...
        logger.warn('⚠️ No DISCORD_GUILD_ID / DISCORD_SUPPORT_GUILD_ID set — server-only commands will not be registered anywhere. Set a guild ID for instant updates.');
    }
}
