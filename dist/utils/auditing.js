 ...
 */
export async function sendAuditLog(client, guildId, title, description, accent = ComponentsV2.Accents.info) {
    try {
 ...
 */
export async function sendNotificationDM(client, discordId, container, // ContainerBuilder
category) {
    try {
        if (category) {
